...
import {RETH, WETH, UNISWAP_V3_SWAP_ROUTER_02, UNISWAP_V3_POOL_FEE_RETH_WETH} from "@src/Constants.sol";
...
contract SwapUniswapV3 {
    ...
    function swapWethToReth(
        uint256 wethAmountIn,
        uint256 rEthAmountOutMin
    ) external {
        // Write your code inside here: Ex 27
    ...
    function swapRethToWeth(
        uint256 rEthAmountIn,
        uint256 wethAmountOutMin
    ) external {
        // Write your code inside here: Ex 31
